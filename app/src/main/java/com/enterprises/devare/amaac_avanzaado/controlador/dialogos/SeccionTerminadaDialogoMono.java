...
import com.enterprises.devare.amaac_avanzaado.controlador.adapters.MonosilabasEjercicios_main;

/**
 * Created by Angel on 14/04/2017.
 */

public class SeccionTerminadaDialogoMono extends DialogFragment{

    public SeccionTerminadaDialogoMono() {
    }
        ...
        btn_continuar_nivel.setOnClickListener(
                new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        Intent i= new Intent(getActivity(), MonosilabasEjercicios_main.class);
                        startActivity(i);
                        dismiss();
                    }
                }
