...
import com.enterprises.devare.amaac_avanzaado.controlador.adapters.BisilabasEjercicios_main;
...
public class SeccionTerminadaDialogoBisi extends DialogFragment{

    public SeccionTerminadaDialogoBisi() {
    }
        ...
        btn_continuar_nivel.setOnClickListener(
                new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        Intent i= new Intent(getActivity(), BisilabasEjercicios_main.class);
                        startActivity(i);
                        dismiss();
                    }
                }
