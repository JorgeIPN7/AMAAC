...
import com.enterprises.devare.amaac_avanzaado.controlador.adapters.PolisilabasEjercicios_main;

/**
 * Created by Angel on 14/04/2017.
 */

public class SeccionTerminadaDialogoPoli extends DialogFragment{

    public SeccionTerminadaDialogoPoli() {
    }
        ...
        btn_continuar_nivel.setOnClickListener(
                new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        Intent i= new Intent(getActivity(), PolisilabasEjercicios_main.class);
                        startActivity(i);
                        dismiss();
                    }
                }
