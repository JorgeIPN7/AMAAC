...
public class SeccionTerminadaDialogoConsonantes extends DialogFragment{

    public SeccionTerminadaDialogoConsonantes() {
    }
        ...
        btn_continuar_nivel.setOnClickListener(
                new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        Intent i= new Intent(getActivity(), ConsonantesEjercicios_main.class);
                        startActivity(i);
                        dismiss();
                    }
                }
