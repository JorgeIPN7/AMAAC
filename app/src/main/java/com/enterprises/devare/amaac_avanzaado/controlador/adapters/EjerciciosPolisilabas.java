                            ...
                            public void run() {
                                while (isMPPlaying) {
                                    ...
                                    try {
                                        ...
                                        if (posicionActual >= 11500 && posicionActual <= 14500) {
                                            ...
                                            ((EjerciciosViewHolder) holder).tv_etiempo.post(new Runnable() {
                                                ...
                                                public void run() {
                                                    ...
                                                    ((EjerciciosViewHolder) holder).tv_etiempo.setText(getHRM(14500 - posicionActual));
                                        ...
                                        }else if (posicionActual >= 14500 && posicionActual <= 25500) {
